...
function verificaStatusPoltrona(poltrona){
  ...
  if(reservadas.includes.toString()){
...
frm.btnConfirmar.addEventListener('click', () =>{
  ...
  const reservadas = localStorage.getItem('storageReservadas').split(',')
